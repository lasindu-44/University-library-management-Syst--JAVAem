...
public class AddMag extends JFrame implements ActionListener{
	...
	contentPane.setLayout(null);
        ...
        JLabel l6 = new JLabel("Magazine_id");
	...
	panel.setBorder(new TitledBorder(new LineBorder(new Color(138, 43, 226), 2), "Add Magazine", TitledBorder.LEADING,
    ...
    public void actionPerformed(ActionEvent e) {
        try {
            ...
            if(e.getSource() == b1){
                String sql = "insert into magazine(mag_id, name, language, pubdate, pages, publisher_id, pubname, pubphone, price) values(?, ?, ?, ?, ?, ?, ?, ?, ?)";
