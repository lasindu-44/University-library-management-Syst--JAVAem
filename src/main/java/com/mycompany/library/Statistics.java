...
public class Statistics extends JFrame{
	...
	panel.setBorder(new TitledBorder(new LineBorder(new Color(47, 79, 79), 2, true), "Issue-Details",
	...
	ImageIcon i1 = new ImageIcon("C:/Users/crx/Documents/NetBeansProjects/library/src/main/java/img/icons/tenth.png");
	...
	panel_1.setBorder(new TitledBorder(new LineBorder(new Color(0, 204, 153), 2, true), "Return-Details",
