...
public class LecturerDetails extends JFrame implements ActionListener{
	...
	JLabel l1 = new JLabel("Lecturer Details");
	...
	panel.setBorder(new TitledBorder(new LineBorder(new Color(95, 158, 160), 3, true), "Lecturer-Details",
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            ...
            connect con = new connect();
            if( ae.getSource() == b1){
                String sql = "select * from lecturer where concat(name, student_id) like ?";
		PreparedStatement st = con.c.prepareStatement(sql);
		...
		st.close();
            ...
            if(ae.getSource() == b2){
                String sql = "delete from lecturer where name = '" + search.getText() + "'";
		PreparedStatement st = con.c.prepareStatement(sql);
