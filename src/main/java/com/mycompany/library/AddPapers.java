...
public class AddPapers extends JFrame implements ActionListener{
	...
	JLabel l4 = new JLabel("Publisher ID");
	...
	comboBox.setModel(new DefaultComboBoxModel(new String[] { "Past", "Model" }));
	...
	panel.setBorder(new TitledBorder(new LineBorder(new Color(138, 43, 226), 2), "Add Papers", TitledBorder.LEADING,
			TitledBorder.TOP, null, new Color(0, 0, 255)));
	panel.setBounds(10, 29, 400, 300);
    ...
    public void actionPerformed(ActionEvent e) {
        try {
            ...
            if(e.getSource() == b1){
                String sql = "insert into paper(paper_id, name, language, type, publisher_id, pages) values(?, ?, ?, ?, ?, ?)";
